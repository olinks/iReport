<div class="main_content_iner overly_inner ">
    <div class="container-fluid p-0 ">
        ...
        <div class="row ">
                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Number Of Reports</h3>
                            </div>
            ...
            <!-- <div class="col-xl-4 ">
                <div class="white_card card_height_100 mb-30 sales_card_wrapper">
                        ...
                        <div class="monthly_plan_wraper">
                            <div class="single_plan d-flex align-items-center justify-content-between">
                                <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                        <img src="assets/img/crome.png" alt="">
                                    </div>
                                    <div>
                                        <h5>Chrome Users</h5>
                                        <span>Today</span>
                        ...
                        <div class="row height_100">
                            <div class="col-lg-6">
                                ...
                                <div class="weather_img_1 mt_30">
                                    <img class="img-fluid" src="assets/img/man.png" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
